<x-guest-layout>
    ...
    <div class="ppb_wrapper  ">
        ...
        <div class="one withsmallpadding ppb_contact_half_bg withbg parallax " style="background-image:url(car_assets/upload/evening.jpg);background-position: center center;padding:40px 0 40px 0;">
            <div class="standard_wrapper">
                <div class="page_content_wrapper">
                    <div class="inner">
                ...
                <div id="15722574382014118329" class="portfolio_filter_wrapper gallery five_cols" data-columns="5">
                    <div class="element grid photoframe fixed_columns classic5_cols animated1">
                        <div class="one_fifth gallery5 classic filterable">
                            <div class="post_img"><img class="team_pic" src="upload/pexels-photo-62365-500x500.jpg" alt="" />
                    ...
                    <div class="element grid photoframe fixed_columns classic5_cols animated2">
                        <div class="one_fifth gallery5 classic filterable">
                            <div class="post_img"><img class="team_pic" src="upload/pexels-photo-57759-500x500.jpg" alt="" />
                                <ul class="social_wrapper team">
                    ...
                    <div class="element grid photoframe fixed_columns classic5_cols animated3">
                        <div class="one_fifth gallery5 classic filterable">
                            <div class="post_img"><img class="team_pic" src="upload/pexels-photo-176045-500x500.jpg" alt="" />
                                <ul class="social_wrapper team">
                    ...
                    <div class="element grid photoframe fixed_columns classic5_cols animated4">
                        <div class="one_fifth gallery5 classic filterable">
                            <div class="post_img"><img class="team_pic" src="upload/pexels-photo-167471-500x500.jpg" alt="" />
                                <ul class="social_wrapper team">
                    ...
                    <div class="element grid photoframe fixed_columns classic5_cols animated5">
                        <div class="one_fifth gallery5 classic filterable">
                            <div class="post_img"><img class="team_pic" src="upload/pexels-photo-48646-1-500x500.jpg" alt="" />
                                <ul class="social_wrapper team">
    ...
    <div class="standard_wrapper">
        ...
        <div id="portfolio_filter_wrapper" class="gallery grid four_cols portfolio-content section content clearfix" data-columns="4">
            <div class="element grid classic4_cols animated1">
                ...
                <div class="one_fourth gallery4 grid static filterable portfolio_type themeborder" data-id="post-1" style="background-image:url(car_assets/upload/mercedes-benz-cls-class-shooting-brake-13824-1920x1200-700x466.jpg);">
            ...
            <div class="element grid classic4_cols animated2">
                ...
                <div class="one_fourth gallery4 grid static filterable portfolio_type themeborder" data-id="post-2" style="background-image:url(car_assets/upload/P14_0596_a4_rgb-1-700x466.jpg);">
                    <a class="car_image" href="#"></a>
                    <div class="portfolio_info_wrapper">
                        <div class="car_attribute_wrapper">
            ...
            <div class="element grid classic4_cols animated3">
                ...
                <div class="one_fourth gallery4 grid static filterable portfolio_type themeborder" data-id="post-3" style="background-image:url(car_assets/upload/2016-Mercedes-Benz-GLE-2-700x466.jpg);">
                    <a class="car_image" href="#"></a>
                    <div class="portfolio_info_wrapper">
                        <div class="car_attribute_wrapper">
            ...
            <div class="element grid classic4_cols animated4">
                ...
                <div class="one_fourth gallery4 grid static filterable portfolio_type themeborder" data-id="post-4" style="background-image:url(car_assets/upload/Porsche-Boxster-Wheels-8-700x466.jpg);">
                    <a class="car_image" href="#"></a>
                    <div class="portfolio_info_wrapper">
                        <div class="car_attribute_wrapper">
