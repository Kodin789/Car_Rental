<x-guest-layout>
    ...
    <div class="ppb_wrapper  ">
        <div class="parallax " style="background-image: url(car_assets/upload/IMG_3496bfree.jpg);height:40vh; "></div>
                ...
                <div class="page_content_wrapper">
                    <div class="inner">
                        <div style="margin:auto;width:100%">
                            <h2 class="ppb_title" style="color:#ffffff;">Premium Car Rental &amp; Limousines Services
                            </h2>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="inner">
                        <div style="margin:auto;width:100%">
                            ...
                            <div class="one_third " style="">
                                <span class="ti-car"
                                    style="display:block;font-size:50px;margin-bottom:20px;">&nbsp;</span></p>
        ...
        <div class="one">
            <div class="one_half_bg parallax"
                style="background-image:url(car_assets/upload/pexels-photo-2.jpg);height:550px;"></div>
            <div class="one_half_bg" style="padding:80px;">
                <h2 class="ppb_title" style="">Car Rental</h2>
                <div class="ppb_header_content">
                    <p>Meh synth Schlitz, tempor duis single-origin coffee ea next level ethnic fingerstache fanny pack
                        nostrud. Photo booth anim 8-bit hella, PBR 3 wolf moon beard Helvetica. Salvia esse nihil,
                        flexitarian Truffaut synth art party deep v chillwave. Seitan High Life reprehenderit
                        consectetur cupidatat kogi. Et leggings fanny pack, elit bespoke vinyl art party Pitchfork
                        selfies master cleanse Kickstarter seitan retro.</p>
                    <p><a class="button" style="margin-top:20px;" href="#">View Plan &amp; Price</a></p>
                </div>
            </div>
            <br class="clear" />
        </div>
        <div class="one">
            <div class="one_half_bg textright" style="padding:80px;">
                <h2 class="ppb_title" style="">Limousine</h2>
                <div class="ppb_header_content">
                    <p>Meh synth Schlitz, tempor duis single-origin coffee ea next level ethnic fingerstache fanny pack
                        nostrud. Photo booth anim 8-bit hella, PBR 3 wolf moon beard Helvetica. Salvia esse nihil,
                        flexitarian Truffaut synth art party deep v chillwave. Seitan High Life reprehenderit
            ...
            <div class="one_half_bg parallax"
                style="background-image:url(car_assets/upload/nw6xremkxkg-nicolai-berntsen.jpg);height:550px;"></div>
            <br class="clear" />
        </div>
        <div class="one">
            <div class="one_half_bg parallax"
                style="background-image:url(car_assets/upload/pexels-photo-112631.jpg);height:550px;"></div>
            <div class="one_half_bg" style="padding:80px;">
                <h2 class="ppb_title" style="">Weddings &amp; Parties</h2>
                <div class="ppb_header_content">
                    <p>Meh synth Schlitz, tempor duis single-origin coffee ea next level ethnic fingerstache fanny pack
                        nostrud. Photo booth anim 8-bit hella, PBR 3 wolf moon beard Helvetica. Salvia esse nihil,
                        flexitarian Truffaut synth art party deep v chillwave. Seitan High Life reprehenderit
            ...
            <div id="portfolio_filter_wrapper" class="gallery grid four_cols portfolio-content section content clearfix"
                ...
                <div class="element grid classic4_cols animated1">
                    ...
                    <div class="one_fourth gallery4 grid static filterable portfolio_type themeborder" data-id="post-1"
                        style="background-image:url(car_assets/upload/mercedes-benz-cls-class-shooting-brake-13824-1920x1200-700x466.jpg);">
                        ...
                        <div class="portfolio_info_wrapper">
                            ...
                            <div class="car_attribute_price">
                                <div class="car_attribute_price_day four_cols">
                                    <span class="single_car_currency">$</span><span class="single_car_price">100</span>
                ...
                <div class="element grid classic4_cols animated2">
                    ...
                    <div class="one_fourth gallery4 grid static filterable portfolio_type themeborder" data-id="post-2"
                        style="background-image:url(car_assets/upload/P14_0596_a4_rgb-1-700x466.jpg);">
                        <a class="car_image" href="#"></a>
                        <div class="portfolio_info_wrapper">
                            <div class="car_attribute_wrapper">
                            ...
                            <div class="car_attribute_price">
                                <div class="car_attribute_price_day four_cols">
                                    <span class="single_car_currency">$</span><span
                                        class="single_car_price">127</span> <span class="car_unit_day">Per Day</span>
                                </div>
                            </div>
                            <br class="clear" />
                        </div>
                ...
                <div class="element grid classic4_cols animated3">
                    ...
                    <div class="one_fourth gallery4 grid static filterable portfolio_type themeborder"
                        data-id="post-3"
                        style="background-image:url(car_assets/upload/2016-Mercedes-Benz-GLE-2-700x466.jpg);">
                        <a class="car_image" href="#"></a>
                        <div class="portfolio_info_wrapper">
                            <div class="car_attribute_wrapper">
                ...
                <div class="element grid classic4_cols animated4">
                    ...
                    <div class="one_fourth gallery4 grid static filterable portfolio_type themeborder"
                        data-id="post-4"
                        style="background-image:url(car_assets/upload/Porsche-Boxster-Wheels-8-700x466.jpg);">
                        <a class="car_image" href="#"></a>
                        <div class="portfolio_info_wrapper">
                            <div class="car_attribute_wrapper">
                            ...
                            <div class="car_attribute_price">
                                <div class="car_attribute_price_day four_cols">
                                    <span class="single_car_currency">$</span><span
                                        class="single_car_price">180</span> <span class="car_unit_day">Per Day</span>
                                </div>
                            </div>
                            <br class="clear" />
                        </div>
