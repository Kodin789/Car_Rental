<x-guest-layout>
    ...
    <div class="ppb_wrapper  ">
        <div class="one withsmallpadding ppb_car_search_background parallax withbg "
            style="padding-top: 150px !important;text-align:center;height:800px;background-image:url(car_assets/upload/IMG_3496bfree.jpg);background-position: center center;color:#ffffff;">
            ...
            <div class="center_wrapper">
                <div class="inner_content">
                    <div class="standard_wrapper">
                        ...
                        <div class="page_tagline" style="color:#ffffff;">From as low as $10 per day with limited time
                            offer discounts</div>
                ...
                <div class="page_content_wrapper">
                    <div class="inner">
                        <div style="margin:auto;width:100%">
                            <h2 class="ppb_title" style="">First Class Car Rental &amp; Limousine Services</h2>
                            <div class="page_tagline" style="">We offer professional car rental &amp; limousine
                                services in our range of high-end vehicles</div>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        @foreach ($cars as $car)
                            <div class="element grid classic3_cols animated1">
                                <div class="one_third gallery3 grid static filterable portfolio_type themeborder"
                                    style="background-image:url(/storage/images/{{ $car->image }});">
                ...
                <div class="standard_wrapper">
                    <div id="1572257266780950625" class="portfolio_filter_wrapper gallery grid portrait three_cols"
                        ...
                        @foreach ($brands as $brand)
                            <div class="element grid classic3_cols animated1">
                                <div class="one_third gallery3 grid static filterable portfolio_type themeborder"
                                    style="background-image:url(/storage/images/{{ $brand->image }});">
                                    <a class="car_image" href="#"></a>
                                    <div class="portfolio_info_wrapper">
                                        <h3>{{ $brand->name }}</h3>
                                    </div>
        ...
        <div class="one withsmallpadding ppb_header_youtube withbg parallax"
            ...
            style="text-align:center;padding:215px 0 215px 0;color:#ffffff;">
            <div class="overlay_background"
                ...
                <div class="page_content_wrapper">
                    <div class="inner">
                        <div style="margin:auto;width:100%">
                            ...
                            <div class="page_tagline" style="color:#ffffff;">We know the difference is in the details
                                and that’s why our car rental services, in the tourism
                                <br /> and business industry, stand out for their quality and good taste, to offer you
                ...
                <div class="page_content_wrapper">
                    <div class="inner">
                        <div style="margin:auto;width:100%">
                            ...
                            <div class="page_tagline" style="">Explore some of the best tips from around the
                                world</div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="post_img small static">
                                            <a href="#">
                                                <img src="/car_assets/upload/nw6xremkxkg-nicolai-berntsen-960x636.jpg"
                                                    alt="What To Do if Your Rental Car Has Met With An Accident"
                                                    class="" />
                                            </a>
                                        </div>
                                        ...
                                        <div class="post_img small static">
                                            <a href="#">
                                                <img src="/car_assets/upload/IMG_3496bfree-960x636.jpg"
                                                    alt="On The Trail of 6 Best Foods in North America"
                                                    class="" />
                                            </a>
                                        </div>
                                        <div class="post_header_wrapper">
                                            <div class="post_header grid">
                                                ...
                                                <h6><a href="#"
                                                        title="On The Trail of 6 Best Foods in North America">On The
                                    ...
                                    <div class="post_wrapper grid_layout">
                                        ...
                                        <div class="post_header_wrapper">
                                            <div class="post_header grid">
                                                ...
                                                <h6><a href="#"
                                                        title="Car Rental Mistakes That Can Cost You Big">Car Rental
