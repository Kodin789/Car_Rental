<x-guest-layout>
    ...
    <div id="page_caption" class="hasbg parallax  withtopbar  " style="background-image:url(car_assets/upload/driver-2.jpg);">
    ...
    <div class="ppb_wrapper hasbg withtopbar">
                ...
                <div class="page_content_wrapper">
                    <div class="inner">
                        <div style="margin:auto;width:80%">
                            ...
                            <h4 class="p1"><span class="s1"><b>Just over a month into my trip and I wonder
                                        how I’ve changed, if at all. Certainly the experiences I’ve had and things
                                        I’ve seen have shaped me in someway. </b></span></h4>
                    ...
                    <div class="inner">
                        <div style="margin:auto;width:60%">
                            <div role="form" class="wpcf7" id="wpcf7-f2465-o1" lang="en-US" dir="ltr">
                                ...
                                <form class="quform"
                                    action="https://max-themes.net/demos/carrental(car_assets/upload/plugins/quform/process.php"
        ...
        <div class="one_half_bg withsmallpadding ppb_text_image withbg parallax "
            style="font-size:18px;background-image:url(car_assets/upload/pexels-photo-165888.jpg);background-position: center center;text-align:center;padding:100px 0 100px 0;color:#ffffff !important;">
        ...
        <div class="one_half_bg last withsmallpadding ppb_text_image withbg parallax "
            style="font-size:18px;background-image:url(car_assets/upload/cfi7_hcxecu-anthony-delanoix.jpg);background-position: center center;text-align:center;padding:100px 0 100px 0;color:#ffffff !important;">
            <div class="overlay_background"
                style="background:#000000;background:rgb(0,0,0,0.5);background:rgba(0,0,0,0.5);"></div>
            <div class="page_content_wrapper">
                <div class="inner">
